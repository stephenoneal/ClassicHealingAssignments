...
function HealingAsssignments.Syncframe:AddDropdown(ProfileNum,TemplateNum,DropType,ActiveTankFrame,ActiveHealerFrame,DropText)
	...
	if DropType == 2 then
		...
		if not HealingAsssignments.Mainframe.Foreground.Profile[ProfileNum].Template[TemplateNum].Assigments.Content.Frame then 
			HealingAsssignments.Mainframe.Foreground.Profile[ProfileNum].Template[TemplateNum].Assigments.Content.Frame = {} 
		end
		...
		if not HealingAsssignments.Mainframe.Foreground.Profile[ProfileNum].Template[TemplateNum].Assigments.Content.Frame[ActiveTankFrame] then	
			HealingAsssignments.Mainframe.Foreground.Profile[ProfileNum].Template[TemplateNum].Assigments.Content.Frame[ActiveTankFrame] = CreateFrame(
				"Frame", 
				nil, 
				HealingAsssignments.Mainframe.Foreground.Profile[ProfileNum].Template[TemplateNum].Assigments.Content
			);
			...
			if not HealingAsssignments.Mainframe.Foreground.Profile[ProfileNum].Template[TemplateNum].Assigments.Content.Frame[ActiveTankFrame].Tank then 
				HealingAsssignments.Mainframe.Foreground.Profile[ProfileNum].Template[TemplateNum].Assigments.Content.Frame[ActiveTankFrame].Tank = {} 
			end;
			HealingAsssignments.Mainframe.Foreground.Profile[ProfileNum].Template[TemplateNum].Assigments.Content.Frame[ActiveTankFrame].Tank[ActiveTankFrame] = CreateFrame(
				"Button",
				"HADropdown"..DropDownCount, 
				HealingAsssignments.Mainframe.Foreground.Profile[ProfileNum].Template[TemplateNum].Assigments.Content.Frame[ActiveTankFrame], 
			...
			_G[HealingAsssignments.Mainframe.Foreground.Profile[ProfileNum].Template[TemplateNum].Assigments.Content.Frame[ActiveTankFrame].Tank[ActiveTankFrame]:GetName().."Button"]:SetScript("OnClick", function(...)
				...
				local DropDownID = _G[HealingAsssignments.Mainframe.Foreground.Profile[ProfileNum].Template[TemplateNum].Assigments.Content.Frame[ActiveTankFrame].Tank[ActiveTankFrame]:GetName()];
			...
			_G[HealingAsssignments.Mainframe.Foreground.Profile[ProfileNum].Template[TemplateNum].Assigments.Content.Frame[ActiveTankFrame].Tank[ActiveTankFrame]:GetName().."Text"]:SetText(DropText);
			...
			if not HealingAssignmentsTemplates.Profile[ProfileNum].Template[TemplateNum].Tank then 
				HealingAssignmentsTemplates.Profile[ProfileNum].Template[TemplateNum].Tank = {} 
			end
	...
	elseif DropType > 2 then
		if	not HealingAsssignments.Mainframe.Foreground.Profile[ProfileNum].Template[TemplateNum].Assigments.Content.Frame[ActiveTankFrame].Healer or 
			not HealingAsssignments.Mainframe.Foreground.Profile[ProfileNum].Template[TemplateNum].Assigments.Content.Frame[ActiveTankFrame].Healer[ActiveHealerFrame] then
			HealingAsssignments.Mainframe.DropDownCounter = HealingAsssignments.Mainframe.DropDownCounter +1
			local DropDownCount = HealingAsssignments.Mainframe.DropDownCounter
			if not HealingAsssignments.Mainframe.Foreground.Profile[ProfileNum].Template[TemplateNum].Assigments.Content.Frame[ActiveTankFrame].Healer then 
				HealingAsssignments.Mainframe.Foreground.Profile[ProfileNum].Template[TemplateNum].Assigments.Content.Frame[ActiveTankFrame].Healer = {} 
			end;
			HealingAsssignments.Mainframe.Foreground.Profile[ProfileNum].Template[TemplateNum].Assigments.Content.Frame[ActiveTankFrame].Healer[ActiveHealerFrame] = CreateFrame(
				"Button",
				"HADropdown"..DropDownCount, 
				HealingAsssignments.Mainframe.Foreground.Profile[ProfileNum].Template[TemplateNum].Assigments.Content.Frame[ActiveTankFrame], 
				"UIDropDownMenuTemplate"
			...
			_G[HealingAsssignments.Mainframe.Foreground.Profile[ProfileNum].Template[TemplateNum].Assigments.Content.Frame[ActiveTankFrame].Healer[ActiveHealerFrame]:GetName().."Button"]:SetScript("OnClick", function(...)
				...
				local DropDownID = _G[HealingAsssignments.Mainframe.Foreground.Profile[ProfileNum].Template[TemplateNum].Assigments.Content.Frame[ActiveTankFrame].Healer[ActiveHealerFrame]:GetName()];
			...
			_G[HealingAsssignments.Mainframe.Foreground.Profile[ProfileNum].Template[TemplateNum].Assigments.Content.Frame[ActiveTankFrame].Healer[ActiveHealerFrame]:GetName().."Text"]:SetText(DropText);
			
			if math.fmod(ActiveHealerFrame,4) == 1 then 
				x = 137; 
				y = math.floor((ActiveHealerFrame/4)-(1/5))*(-60); 
				HealingAsssignments.Mainframe.Foreground.Profile[ProfileNum].Template[TemplateNum].Assigments.Content.Frame[ActiveTankFrame]:SetHeight((math.floor((ActiveHealerFrame/3)-(1/5)))*60+60)
			...
			if not HealingAssignmentsTemplates.Profile[ProfileNum].Template[TemplateNum].Tankhealernames then 
				HealingAssignmentsTemplates.Profile[ProfileNum].Template[TemplateNum].Tankhealernames = {} 
			end
			if not HealingAssignmentsTemplates.Profile[ProfileNum].Template[TemplateNum].Tankhealernames[ActiveTankFrame] then 
				HealingAssignmentsTemplates.Profile[ProfileNum].Template[TemplateNum].Tankhealernames[ActiveTankFrame] = {} 
			end
			if not HealingAssignmentsTemplates.Profile[ProfileNum].Template[TemplateNum].Tankhealernames[ActiveTankFrame].Healer then 
				HealingAssignmentsTemplates.Profile[ProfileNum].Template[TemplateNum].Tankhealernames[ActiveTankFrame].Healer = {} 
			end
...
function HealingAsssignments.Syncframe:TriggerSync()
	if HealingAsssignments.Mainframe.SyncCheckbox:GetChecked() == 1 then
		SendAddonMessage("CHTrigger","trigger", "RAID")
	end
end
...
function HealingAsssignments.Syncframe:ResetDropdownText(ProfileNum,TemplateNum)
	...
	for i=1,TankNum do
		...
		_G[HealingAsssignments.Mainframe.Foreground.Profile[ProfileNum].Template[TemplateNum].Assigments.Content.Frame[i].Tank[i]:GetName().."Text"]:SetText(" ");
		...
		for j=1,HealerNum do
			...
			_G[HealingAsssignments.Mainframe.Foreground.Profile[ProfileNum].Template[TemplateNum].Assigments.Content.Frame[i].Healer[j]:GetName().."Text"]:SetText(" ")
		end
	end
end
...
function HealingAsssignments.Syncframe:Send()
	...
	for n=1,TemplateNum do
		...
		for i=1,TankNum do
			...
			TankName = _G[HealingAsssignments.Mainframe.Foreground.Profile[1].Template[n].Assigments.Content.Frame[i].Tank[i]:GetName().."Text"]:GetText(" ");
			...
			for j=1,HealerNum do
				...
				HealerName = _G[HealingAsssignments.Mainframe.Foreground.Profile[1].Template[n].Assigments.Content.Frame[i].Healer[j]:GetName().."Text"]:GetText(" ");
			...
			if n<10 then 
				TemplateNumberString = "0"..n 
			else 
				TemplateNumberString = n 
			end
			SendAddonMessage("CHA$"..TemplateNumberString.."$"..TemplateName ,SendString, "RAID")
		end
	end
