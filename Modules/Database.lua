...
local CHA_NAME_GROUPS12	= "GROUPS12";
local CHA_NAME_GROUPS34	= "GROUPS34";
local CHA_NAME_GROUPS56	= "GROUPS56";
local CHA_NAME_GROUPS78	= "GROUPS78";
...
local CHA_Names = {
	{ CHA_NAME_GROUPS12,	"Groups 1 & 2",		"Groups 1 & 2",		"FFA400" },
	{ CHA_NAME_GROUPS34,	"Groups 3 & 4",		"Groups 3 & 4",		"FFFF00" },
	{ CHA_NAME_GROUPS56,	"Groups 5 & 6",		"Groups 5 & 6",		"00A0FF" },
	{ CHA_NAME_GROUPS78,	"Groups 7 & 8",		"Groups 7 & 8",		"FF00FF" },
	{ CHA_NAME_CUSTOM2,		CHA_NAME_CUSTOM2,	CHA_NAME_CUSTOM2,	"FF00FF" },
	{ CHA_NAME_TANKS,	"Tanks",		"Tanks",		"C79C6E" },
	{ CHA_NAME_RAID,	"Raid",		"Raid",		"00FFFF" },
	{ CHA_NAME_LEFTSIDE,	"<< Left side",		"<< Left side",		"FF0000" },
	{ CHA_NAME_RIGHTSIDE,	"Right side >>",	"Right side >>",	"00FF00" },
	{ CHA_NAME_CUSTOM,		CHA_NAME_CUSTOM,	CHA_NAME_CUSTOM,	"00FF00" },
...
function HealingAsssignments.Mainframe:PopulateTankDropdown()
	...
	local Groups12Check = HealingAsssignments.Mainframe.Foreground.Profile[1].Template[OptionsFrame].Assigments.Content.Groups12Checkbox:GetChecked();
	local Groups34Check = HealingAsssignments.Mainframe.Foreground.Profile[1].Template[OptionsFrame].Assigments.Content.Groups34Checkbox:GetChecked();
	local Groups56Check = HealingAsssignments.Mainframe.Foreground.Profile[1].Template[OptionsFrame].Assigments.Content.Groups56Checkbox:GetChecked();
	local Groups78Check = HealingAsssignments.Mainframe.Foreground.Profile[1].Template[OptionsFrame].Assigments.Content.Groups78Checkbox:GetChecked();
	...
	local names;
	if Groups12Check then 
		names = HealingAsssignments:GetNames(CHA_NAME_GROUPS12);
		info.text = names[2];
		info.colorCode = "|c00".. names[4];
		info.checked = false
		info.notCheckable = true
	...
	if Groups34Check then 
		names = HealingAsssignments:GetNames(CHA_NAME_GROUPS34);
		info.text = names[2];
		info.colorCode = "|c00".. names[4];
		info.checked = false
		info.notCheckable = true
	...
	if Groups56Check then 
		names = HealingAsssignments:GetNames(CHA_NAME_GROUPS56);
		info.text = names[2];
		info.colorCode = "|c00".. names[4];
		info.checked = false
		info.notCheckable = true
	...
	if Groups78Check then 
		names = HealingAsssignments:GetNames(CHA_NAME_GROUPS78);
		info.text = names[2];
		info.colorCode = "|c00".. names[4];
		info.checked = false
		info.notCheckable = true
